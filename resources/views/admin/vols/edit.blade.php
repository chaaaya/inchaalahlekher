...
@section('content-admin')
    ...
    <form action="{{ route('admin.vols.update', $vol->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" id="heure_arrivee" name="heure_arrivee" class="form-control" value="{{ old('heure_arrivee', \Carbon\Carbon::parse($vol->heure_arrivee)->format('Y-m-d\TH:i')) }}">
        </div>
